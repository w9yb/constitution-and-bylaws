...
applied for and received shall be managed in a distict fund for each grant; each
grant budget will be the money from the relevant grant minus money spent from
it.

Income and expenses for the officer discretionary and general budgets shall be
tracked on seperate annual periods. The income term will coincide with the
annual officer term, beginning and ending on the last regular meeting date of
the spring semester whereas expenses will be accounted for based on the annual
membership term, changing over on the third regular meeting date of the fall
semester. This means that during the summer, money recieved will count towards
the coming school year while money spent will be restricted by the budgets of
the prior year.
...
expenditures as soon as its spending is approved. If a purchase or fund comes
out to less than the approved amount or if its approval is retracted by vote
before any money was spent, the unspent money will be readded to the relevant
budget.
...
To be considered, the effect of spending proposals on the club's budgets and
balance must be documented. This can be done by including a section in the
proposal from the treasurer detailing the effect of the proposal, as long as it
is current at the time of voting on the proposal. Alternatively, if the
treasurer is in attendance when the proposal is introduced and voted on, the
treasurer can report these effects at such times. The treasurer shall prepare
...
if they spend money not currently available in the budgets they propose spending
from.
...
regular meeting. Should any item recieve two objections from the membership, the
treasurer will notify the potential reimbursee, and the matter will brought back
up at the next opportunity where the reimbursement may be rejected by a
two-thirds vote. The reimbursee is free to make another spending proposal for
the same items or, in serious cases, take the matter up with the Business Office
...
introduced to seek approval by more than half of all voting members.
